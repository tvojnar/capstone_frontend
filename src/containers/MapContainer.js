...
export class MapContainer extends Component {
  ...
  render() {
    ...
    console.log('in MapComponent render');
    console.log(lat);
    ...
    return(
      <Map
        xMapBoundsMin={this.xMapBounds.min}
        xMapBoundsMax={this.xMapBounds.max}
        yMapBoundsMin={this.yMapBounds.min}
        yMapBoundsMax={this.yMapBounds.max}
